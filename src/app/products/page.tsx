...
export const metadata: Metadata = {
  title: 'Products',
  description: 'Browse 231 products across 46 categories — Lion Pneumatic Tools & GOWIN hand tools at S V Sales Corporation, Mysore.',
}
      ...
      <div className="bg-brand-dark py-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-brand-silver text-lg max-w-xl mx-auto">
            231 products across 46 categories — Lion pressure washers &amp; pneumatic tools plus GOWIN vices, hand tools &amp; garage equipment
          </p>
        </div>
      </div>
