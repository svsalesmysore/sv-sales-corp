...
export const socketsDriverProducts: Product[] = [
  { id: 'socket-box-half', name: 'Socket Box 1/2" Drive', description: 'Complete socket set in 1/2" drive with box', categoryId: 'sockets-drives', subcategory: 'Socket Sets', unit: 'Box', imageQuery: 'socket set 1/2 drive box automotive', tags: ['socket','set','1/2 drive'], inStock: true, sketchfabModelId: 'e4167894763f4c839b4bf3c7f5e8a704' },
